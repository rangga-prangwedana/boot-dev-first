class Rectangle:
    def overlaps(self, rect):
        # still trying
        if not self.get_left_x() <= rect.get_right_x():
            return False
        elif not self.get_right_x() >= rect.get_left_x():
            return False
        elif not self.get_top_y() >= rect.get_bottom_y():
            return False
        elif not self.get_bottom_y() <= rect.get_top_y():
            return False
